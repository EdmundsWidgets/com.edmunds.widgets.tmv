/**
 * Created by Ivan_Kauryshchanka on 2/23/2015.
 */
(function(global, $) {
    'use strict';
    ...
    VehicleConfigurator.prototype = {
        ...
        getJavaScriptSnippet: function() {
            var template = this.htmlEntities([
                '<script type="text/javascript" src="' + VehicleConfigurator.ORIGIN + '/loader-cohran.js"></script>\n',
        ...
        getIframeUrl: function(debug) {
            var url = VehicleConfigurator.ORIGIN + '/nvcCohran/iframe',
